...
; Podpisywanie kodu — AKTYWNE tylko gdy ISCC dostanie /DSIGN (prywatny installer\build.ps1,
; ktory definiuje narzedzie "winmdsign" przez /S i podpisuje certem tmfgroup). Bez /DSIGN
; (np. build u kogokolwiek z repo) instalator powstaje NIEPODPISANY — i tak ma byc.
#ifdef SIGN
SignTool=winmdsign
